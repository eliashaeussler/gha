...
```yaml
uses: eliashaeussler/gha/.github/actions/assure-version-tag@0.9.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/checkout@0.9.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/has-pr@0.9.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/is-merge-commit@0.9.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/is-private-repo@0.9.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/is-fork@0.9.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/is-tag@0.9.3
```
...
| Action                                      | Reference                                               |
|---------------------------------------------|---------------------------------------------------------|
| [Build Docker images](#build-docker-images) | `eliashaeussler/gha/.github/actions/build-docker@0.9.3` |
| [Build assets](#build-assets)               | `eliashaeussler/gha/.github/actions/build-assets@0.9.3` |
| [Build PHAR](#build-phar)                   | `eliashaeussler/gha/.github/actions/build-phar@0.9.3`   |

### [Build Docker images](../.github/actions/build-docker/action.yaml)

```yaml
uses: eliashaeussler/gha/.github/actions/build-docker@0.9.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/build-assets@0.9.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/build-phar@0.9.3
```
...
| Action                                          | Reference                                                   |
|-------------------------------------------------|-------------------------------------------------------------|
| [Composer checks](#composer-checks)             | `eliashaeussler/gha/.github/actions/composer-checks@0.9.3`  |
| [Composer install](#composer-install)           | `eliashaeussler/gha/.github/actions/composer-install@0.9.3` |
| [Composer tests](#composer-tests)               | `eliashaeussler/gha/.github/actions/composer-tests@0.9.3`   |
| [Setup PHP environment](#setup-php-environment) | `eliashaeussler/gha/.github/actions/setup-php@0.9.3`        |

### [Composer checks](../.github/actions/composer-checks/action.yaml)

```yaml
uses: eliashaeussler/gha/.github/actions/composer-checks@0.9.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/composer-install@0.9.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/composer-tests@0.9.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/setup-php@0.9.3
```
...
| Action                                            | Reference                                              |
|---------------------------------------------------|--------------------------------------------------------|
| [npm checks](#npm-checks)                         | `eliashaeussler/gha/.github/actions/npm-checks@0.9.3`  |
| [npm install](#npm-install)                       | `eliashaeussler/gha/.github/actions/npm-install@0.9.3` |
| [Setup node environment](#setup-node-environment) | `eliashaeussler/gha/.github/actions/setup-node@0.9.3`  |

### [npm checks](../.github/actions/npm-checks/action.yaml)

```yaml
uses: eliashaeussler/gha/.github/actions/npm-checks@0.9.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/npm-install@0.9.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/setup-node@0.9.3
```
...
| Action                    | Reference                                             |
|---------------------------|-------------------------------------------------------|
| [Setup DDEV](#setup-ddev) | `eliashaeussler/gha/.github/actions/setup-ddev@0.9.3` |

### [Setup DDEV](../.github/actions/setup-ddev/action.yaml)

```yaml
uses: eliashaeussler/gha/.github/actions/setup-ddev@0.9.3
```
...
| Action                                                                | Reference                                               |
|-----------------------------------------------------------------------|---------------------------------------------------------|
| [Deploy application with Deployer](#deploy-application-with-deployer) | `eliashaeussler/gha/.github/actions/deploy-app@0.9.3`   |
| [Deploy to GitHub Pages](#deploy-to-github-pages)                     | `eliashaeussler/gha/.github/actions/deploy-pages@0.9.3` |

### [Deploy application with Deployer](../.github/actions/deploy-app/action.yaml)

```yaml
uses: eliashaeussler/gha/.github/actions/deploy-app@0.9.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/deploy-pages@0.9.3
```
