...
```yaml
uses: eliashaeussler/gha/.github/workflows/checks.yaml@0.8.2
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/crowdin.yaml@0.8.2
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/devsecops.yaml@0.8.2
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/github-release.yaml@0.8.2
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/preparation.yaml@0.8.2
```
...
| Workflow                   | Reference                                                         |
|----------------------------|-------------------------------------------------------------------|
| [Asset integrity](#checks) | `eliashaeussler/gha/.github/workflows/asset-integrity.yaml@0.8.2` |

### [Asset integrity](../.github/workflows/asset-integrity.yaml)

```yaml
uses: eliashaeussler/gha/.github/workflows/asset-integrity.yaml@0.8.2
```
...
| Workflow                                          | Reference                                                                |
|---------------------------------------------------|--------------------------------------------------------------------------|
| [Composer tests](#composer-tests)                 | `eliashaeussler/gha/.github/workflows/composer-tests.yaml@0.8.2`         |
| [Composer test coverage](#composer-test-coverage) | `eliashaeussler/gha/.github/workflows/composer-test-coverage.yaml@0.8.2` |

### [Composer tests](../.github/workflows/composer-tests.yaml)

```yaml
uses: eliashaeussler/gha/.github/workflows/composer-tests.yaml@0.8.2
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/composer-test-coverage.yaml@0.8.2
```
...
| Workflow                                    | Reference                                                                |
|---------------------------------------------|--------------------------------------------------------------------------|
| [Prepare TYPO3 tests](#prepare-typo3-tests) | `eliashaeussler/gha/.github/workflows/typo3-test-preparation.yaml@0.8.2` |
| [TYPO3 tests](#typo3-tests)                 | `eliashaeussler/gha/.github/workflows/typo3-tests.yaml@0.8.2`            |
| [TYPO3 test coverage](#typo3-test-coverage) | `eliashaeussler/gha/.github/workflows/typo3-test-coverage.yaml@0.8.2`    |

### [Prepare TYPO3 tests](../.github/workflows/typo3-test-preparation.yaml)

```yaml
uses: eliashaeussler/gha/.github/workflows/typo3-test-preparation.yaml@0.8.2
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/typo3-tests.yaml@0.8.2
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/typo3-test-coverage.yaml@0.8.2
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/typo3-extension-release.yaml@0.8.2
```
