...
```yaml
uses: eliashaeussler/gha/.github/actions/assure-version-tag@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/build-docker@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/build-docs@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/build-phar@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/checkout@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/composer-checks@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/composer-install@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/deploy-pages@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/is-fork@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/is-renovate@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/is-tag@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/npm-checks@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/npm-install@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/setup-node@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/setup-ddev@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/setup-php@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/asset-integrity.yaml@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/checks.yaml@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/composer-tests.yaml@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/composer-test-coverage.yaml@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/crowdin.yaml@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/extension-release.yaml@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/merge.yaml@0.4.3
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/preparation.yaml@0.4.3
```
