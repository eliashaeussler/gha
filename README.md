...
```yaml
uses: eliashaeussler/gha/.github/actions/assure-version-tag@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/build-docker@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/build-docs@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/build-phar@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/checkout@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/composer-checks@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/composer-install@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/deploy-pages@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/is-fork@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/is-renovate@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/is-tag@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/npm-checks@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/npm-install@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/setup-node@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/setup-ddev@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/setup-php@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/asset-integrity.yaml@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/checks.yaml@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/composer-tests.yaml@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/composer-test-coverage.yaml@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/crowdin.yaml@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/extension-release.yaml@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/merge.yaml@fix/endpoints
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/preparation.yaml@fix/endpoints
```
