...
```yaml
uses: eliashaeussler/gha/.github/actions/assure-version-tag@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/build-docker@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/build-docs@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/build-phar@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/checkout@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/composer-checks@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/composer-install@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/deploy-pages@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/is-fork@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/is-renovate@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/is-tag@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/npm-checks@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/npm-install@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/setup-node@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/setup-ddev@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/actions/setup-php@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/asset-integrity.yaml@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/checks.yaml@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/composer-tests.yaml@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/composer-test-coverage.yaml@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/crowdin.yaml@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/extension-release.yaml@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/merge.yaml@task/ddev
```
...
```yaml
uses: eliashaeussler/gha/.github/workflows/preparation.yaml@task/ddev
```
