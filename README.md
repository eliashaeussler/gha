...
steps:
  - name: 'Check tag'
    uses: eliashaeussler/gha/.github/actions/assure-version-tag@0.2.4
```
...
steps:
  - name: 'Build Docker'
    uses: eliashaeussler/gha/.github/actions/build-docker@0.2.4
    with:
      images: |
...
steps:
  - name: 'Build docs'
    uses: eliashaeussler/gha/.github/actions/build-docs@0.2.4
    with:
      command: 'docs:build'
```
...
steps:
  - name: 'Build PHAR'
    uses: eliashaeussler/gha/.github/actions/build-phar@0.2.4
    with:
...
steps:
  - name: 'Checkout'
    uses: eliashaeussler/gha/.github/actions/checkout@0.2.4
```
...
steps:
  - name: 'Perform Composer checks'
    uses: eliashaeussler/gha/.github/actions/composer-checks@0.2.4
```
...
steps:
  - name: 'Install Composer packages'
    uses: eliashaeussler/gha/.github/actions/composer-install@0.2.4
    with:
      dependencies: 'locked'
...
steps:
  - name: 'Deploy'
    uses: eliashaeussler/gha/.github/actions/deploy-pages@0.2.4
    with:
...
steps:
  - name: 'Check fork'
    id: is-fork
    uses: eliashaeussler/gha/.github/actions/is-fork@0.2.4
...
steps:
  - name: 'Check Renovate'
    id: is-renovate
    uses: eliashaeussler/gha/.github/actions/is-renovate@0.2.4
...
steps:
  - name: 'Check tag'
    id: is-tag
    uses: eliashaeussler/gha/.github/actions/is-tag@0.2.4
...
steps:
  - name: 'Perform npm checks'
    uses: eliashaeussler/gha/.github/actions/npm-checks@0.2.4
```
...
steps:
  - name: 'Install npm packages'
    uses: eliashaeussler/gha/.github/actions/npm-install@0.2.4
```
...
steps:
  - name: 'Setup node'
    uses: eliashaeussler/gha/.github/actions/setup-node@0.2.4
    with:
      node-version: '24'
      cache: 'npm'
```
...
steps:
  - name: 'Setup PHP'
    uses: eliashaeussler/gha/.github/actions/setup-php@0.2.4
    with:
      php-version: '8.5'
      ini-file: 'production'
      coverage: 'pcov'
...
jobs:
  asset-integrity:
    ...
    uses: eliashaeussler/gha/.github/workflows/asset-integrity.yaml@0.2.4
...
jobs:
  checks:
    uses: eliashaeussler/gha/.github/workflows/checks.yaml@0.2.4
    with:
      # Composer
      composer: true
      php-version: '8.5'
...
jobs:
  tests:
    uses: eliashaeussler/gha/.github/workflows/composer-tests.yaml@0.2.4
    with:
      php-version: '8.5'
...
jobs:
  test-coverage:
    uses: eliashaeussler/gha/.github/workflows/composer-test-coverage.yaml@0.2.4
    with:
...
jobs:
  merge:
    ...
    uses: eliashaeussler/gha/.github/workflows/merge.yaml@0.2.4
```
...
jobs:
  prepare:
    uses: eliashaeussler/gha/.github/workflows/preparation.yaml@0.2.4
